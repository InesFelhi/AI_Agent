...
|-----------|------|----------|-----------------|----------------------|-------------------------|---------|
| `ntp_server` | String | No | Valid NTP server hostname | {{ ANDROMATE_MIN_APP_SDK }} → {{ ANDROID_CURRENT_APP_SDK }} | {{ ANDROMATE_FIRST_VERSION }} → {{ ANDROMATE_CURRENT_VERSION }} | time.google.com |
...
|-------|------|------------------|----------------------|-------------------------|---------|
| `ntp_offset_output` | Long | When NTP sync succeeds | {{ ANDROMATE_MIN_APP_SDK }} → {{ ANDROID_CURRENT_APP_SDK }} | {{ ANDROMATE_FIRST_VERSION }} → {{ ANDROMATE_CURRENT_VERSION }} | `<ANDROMATE_NULL_VALUE>` |
| `ntp_rtt_output` | Long | When NTP sync succeeds | {{ ANDROMATE_MIN_APP_SDK }} → {{ ANDROID_CURRENT_APP_SDK }} | {{ ANDROMATE_FIRST_VERSION }} → {{ ANDROMATE_CURRENT_VERSION }} | `<ANDROMATE_NULL_VALUE>` |
...
|------|---------------|-------------|
| NTP_CLIENT_ERROR | NTP Client Error | Failed to communicate with NTP server (IOException) or received invalid response. |
